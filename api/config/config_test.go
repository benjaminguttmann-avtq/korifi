...
var _ = Describe("Config", func() {
	...
	It("populates the config", func() {
		...
		Expect(cfg.DefaultBuilderName).To(Equal("my-builder"))
	...
	When("the builderNames is not specified", func() {
		BeforeEach(func() {
	...
	When("the DefaultBuilderName is not specified", func() {
		BeforeEach(func() {
			delete(configMap, "DefaultBuilderName")
		})

		It("returns an error", func() {
			Expect(loadErr).To(MatchError("DefaultBuilderName must have a value"))
		})
	})
